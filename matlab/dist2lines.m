...
% % % Source: https://www.mathworks.com/matlabcentral/fileexchange/29130-shortest-distance-between-two-lines-in-n-dimensions
% % % Licence: BSD
% % %
% % % Changes: 
% % % 1) This code was extended with check if L1 and L2 are paralell 
% % % --------------------------------
function [dist, Pc, Qc]=dist2lines(L1,L2)
...
if (a*c-b^2 < 0.00000000000001) % check if thery are paralell
    sc=0;
    tc=d/b;
